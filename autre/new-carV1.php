<?php
    ...
    //!!! Refaire et voir la correction, car a y avoir un problème. Dans mon cas, même si champ vide, ça va être enregistré dans la base de données
    ...
    if(isset($_POST["marque"]) && isset($_POST["modele"]) && isset($_POST["puissance"]) && isset($_POST["annee"]) && isset($_POST["couleur"])){
        ...
        if(empty($marque) || empty($modele) || empty($puissance) || empty($annee) || empty($couleur)){
